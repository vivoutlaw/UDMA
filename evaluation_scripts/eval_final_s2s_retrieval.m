function eval_final_s2s_retrieval(dataset_name_, model_name_, epoch_number_, method_type_, eval_type_)
...
query_all_feats = hdf5read(filename,'X_').';
...
gallery_all_feats = hdf5read(filename,'X_').';
